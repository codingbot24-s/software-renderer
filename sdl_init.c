...
void apply_transformation(vec3 *original_vert, vec3 *transformed_vert,
                          int original_vert_count, matrix view_matrix);
...
int create_sdl_window() {
  ...
  while (running == true) {
    ...
    fill_triangle(tt_vertices[0], tt_vertices[1], tt_vertices[2], frame_buffer,
                  z_buffer, proj_matrix, color1, color2, color3);
